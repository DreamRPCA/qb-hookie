...
Config.Settings = {
    ['hookies'] = {
        ['duty'] = { 
            coords = vector3(-2194.42, 4290.41, 49.17), -- On Duty settings
            minZ = 25, 
            maxZ = 35,
            length = 0.5,
            width = 0.5,
        ...
        ['stash'] = { 
            coords = vector3(-2193.29, 4286.82, 49.18), -- Coords for worker stash
            minZ = 25, 
            maxZ = 35,
            length = 4,
            width = 0.5,
        ...
        ['bossSettings'] = { -- Boss Action Settings
            ...
            bossJob = 'hookies' -- Name of the job that can access the boss menu
        },
        ['barSettings'] = { -- Bartender Settings
            hash = `a_m_y_business_02`,
            coords = vector4(-2192.19, 4293.78, 49.17, 242.01),
            playAnimation = true
        },
        ['strippers'] = { -- WIP
            enabled = false, -- Enable Strippers
            coords = {
